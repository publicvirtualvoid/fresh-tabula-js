...
TabulaCommand.prototype._build = function (pdfPath, commandArgs) {
  ...
  if (commandArgs && commandArgs.silent) {
    this.args = this.args.concat(['-Dorg.slf4j.simpleLogger.defaultLogLevel=off','-Dorg.apache.commons.logging.Log=org.apache.commons.logging.impl.NoOpLog','-Dfile.encoding=utf-8'])
  }
  this.args = this.args.concat(['-jar', path.join(__dirname, 'jar/tabula-java.jar')]);
